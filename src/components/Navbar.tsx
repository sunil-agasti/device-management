...
export default function Navbar({ systemInfo }: { systemInfo?: { serverUsername: string; serverHostname: string; clientIp: string } }) {
        ...
        <div className="md:hidden border-t border-slate-200 dark:border-slate-700 p-4 space-y-2">
          {systemInfo && (
            <div className="text-xs text-slate-500 dark:text-slate-400">
              {systemInfo.serverUsername} ({systemInfo.serverHostname}) | {systemInfo.clientIp}
            </div>
          )}
