  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        <Link href="/device-management-portal" className="inline-flex items-center gap-1.5 text-sm text-violet-500 hover:text-violet-600 dark:text-violet-400 dark:hover:text-violet-300 transition-colors">
